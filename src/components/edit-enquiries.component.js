...
export default class EditEnquiries extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/enquiries/'+this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/enquiries/update/' + this.props.match.params.id, enquiries)
      ...
      <div class="container my-2">
          <div class="row">
              ...
              <form  >
                      ...
                      <div class="form-group row">
                          <label class="col-sm-2 col-form-label">Messeage:</label>
                          <div class="col-sm-12">
            ...
            />
                      ...
                      <div class="form-group row">
                          <div class="ml-auto px-3">
                            <button onClick={this.onNavigateEnquiries} className="btn btn-danger">Cancel</button>&nbsp;&nbsp;
                          <Link to="" onClick={this.onSubmit}  className="btn btn-primary" ><i class="fa-solid fa-floppy-disk"></i>&nbsp;Save</Link>
                        </div>
